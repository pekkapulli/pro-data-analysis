...
- Teoksen numero: Remove
- Teoksen nimi: Salted hash
- Tilityksen lähde: Keep
- Tilityksen ID: Remove
- Tilityksen nimi: Keep
- Tilityksen pvm: Convert to month/year
- Oikeudenhaltijan IPI-numero: Remove
- Oikeudenhaltijan nimi: Salted hash
- Oikeudenhaltijan rooli: Keep
- Oikeudenhaltijan osuus (%): Keep
- Tilityksen pääkategoria: Keep
- Tilityksen välikategoria: Keep
- Tilityksen alakategoria: Keep
- Alkuperäinen palvelun/toimijan nimi: Remove
- Ohjelman nimi: Remove
- Esityspaikan nimi: Remove
- Esiintyjän nimi: Salted hash
- Esitysajankohta (alku): Month/year only
- Esitysajankohta (loppu): Month/year only
- Esitysmaa: Keep
- ISWC: Remove
- ISRC: Remove
- Oikeustyyppi: Keep
